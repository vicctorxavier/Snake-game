...
function reCumeça () {
    ...
    if (direção == "down") {
        if (proximoY > (canvas.height - 120) && proximoY <= canvas.height) {
...
function movaCroba(event) {
    ...
    if ((event.keyCode == 37 || event.keyCode == 65) && (direção != 'right')) {direção = 'left'; tapAudio();};
    if ((event.keyCode == 38 || event.keyCode == 87) && (direção != 'down')) {direção = 'up'; tapAudio();};
    if ((event.keyCode == 39 || event.keyCode == 68) && (direção != 'left')) {direção = 'right'; tapAudio();};
    if ((event.keyCode == 40 || event.keyCode == 83) && (direção != 'up')) {direção = 'down'; tapAudio();};
